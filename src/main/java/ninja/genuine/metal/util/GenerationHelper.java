...
import ninja.genuine.metal.generator.feature.CommonMetalNode.NodePos;
...
public class GenerationHelper {
	...
	public static int findGroundLevel(final Chunk chunk, final Predicate<Block> groundPredicate) {
		for (int y = chunk.getTopFilledSegment() + 16; y > 1; y--)
			for (int x = 0; x < 16; x++)
				for (int z = 0; z < 16; z++)
					if (groundPredicate.apply(chunk.getBlock(x, y, z)))
